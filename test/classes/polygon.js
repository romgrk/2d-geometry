...
describe('Polygon', function () {
  ...
  it('Can construct Polygon from array of 3 points', function () {
    let polygon = new Polygon()
    let points = [new Point(1, 1), new Point(5, 1), new Point(3, 5)]
  ...
  describe('#Intersections', function () {
    it('Can perform intersection between polygons', function () {
      const poly1 = new Polygon([point(0, 0), point(150, 0), point(150, 30), point(0, 30)])
      const poly2 = new Polygon([point(100, 20), point(200, 20), point(200, 40), point(100, 40)])
