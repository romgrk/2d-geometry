    ...
    insert_fixup(insert_node) {
        ...
        while (current_node != this.root && current_node.parent.color == Color.RED) {
            if (current_node.parent == current_node.parent.parent.left) {   // parent is left child of grandfather
                ...
                if (uncle_node.color == Color.RED) {             // Case 1. Uncle is red
                ...
                if (uncle_node.color == Color.RED) {             // Case 4. Uncle is red
                    // re-color father and uncle into black
                    current_node.parent.color = Color.BLACK;
                    uncle_node.color = Color.BLACK;
                    current_node.parent.parent.color = Color.RED;
    ...
    delete_fixup(fix_node) {
        ...
        while (current_node != this.root && current_node.parent != null && current_node.color == Color.BLACK) {
            if (current_node == current_node.parent.left) {          // fix node is left child
                ...
                if (brother_node.color == Color.RED) {   // Case 1. Brother is red
                ...
                if (brother_node.left.color == Color.BLACK &&
                    brother_node.right.color == Color.BLACK) {  // case 2: both nephews black
                    brother_node.color = Color.RED;              // re-color brother
                    current_node = current_node.parent;                  // continue iteration
                }
                else {
                    if (brother_node.right.color == Color.BLACK) {   // case 3: left nephew red, right nephew black
                        brother_node.color = Color.RED;          // re-color brother
                ...
                // Go to cases 2..4
                if (brother_node.left.color == Color.BLACK &&
                    brother_node.right.color == Color.BLACK) {   // case 2
                    brother_node.color = Color.RED;             // re-color brother
                    current_node = current_node.parent;                              // continue iteration
                }
                else {
                    if (brother_node.left.color == Color.BLACK) {  // case 3: right nephew red, left nephew black
                        brother_node.color = Color.RED;            // re-color brother
