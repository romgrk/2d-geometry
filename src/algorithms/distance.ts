...
export class Distance {
     ...
     */
    static point2point(pt1, pt2): [number, geom.Segment] {
     ...
     * @returns {Number | Segment} - distance and shortest segment
     */
    static segment2segment(seg1, seg2): [number, geom.Segment] {
     ...
     * @returns {Number | Segment} - distance and shortest segment
     */
    static segment2circle(seg, circle): [number, geom.Segment] {
     ...
     * @returns {Number | Segment} - distance and shortest segment
     */
    static segment2arc(seg, arc): [number, geom.Segment] {
     ...
     * @returns {Number | Segment} - distance and shortest segment
     */
    static circle2circle(circle1, circle2): [number, geom.Segment] {
     ...
     * @returns {Number | Segment} - distance and shortest segment
     */
    static circle2line(circle, line): [number, geom.Segment] {
     ...
     * @returns {Number | Segment} - distance and shortest segment
     */
    static arc2line(arc, line): [number, geom.Segment] {
     ...
     * @returns {Number | Segment} - distance and shortest segment
     */
    static arc2circle(arc, circle2): [number, geom.Segment] {
     ...
     * @returns {Number | Segment} - distance and shortest segment
     */
    static arc2arc(arc1, arc2): [number, geom.Segment] {
     ...
     * @returns {Number | Segment} - distance and shortest segment
     */
    static point2polygon(point, polygon): [number, geom.Segment] {
    ...
    static shape2polygon(shape, polygon): [number, geom.Segment] {
        let min_dist_and_segment = [Number.POSITIVE_INFINITY, new geom.Segment()] as [number, geom.Segment];
        for (let edge of polygon.edges) {
     ...
     * @returns {Number | Segment} - distance and shortest segment
     */
    static polygon2polygon(polygon1, polygon2): [number, geom.Segment] {
        let min_dist_and_segment = [Number.POSITIVE_INFINITY, new geom.Segment()] as [number, geom.Segment];
